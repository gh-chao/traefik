...
| `traefik/http/services/Service02/highestRandomWeight/sticky/cookie/httpOnly` | `true` |
| `traefik/http/services/Service02/highestRandomWeight/sticky/cookie/maxAge` | `42` |
| `traefik/http/services/Service02/highestRandomWeight/sticky/cookie/name` | `foobar` |
| `traefik/http/services/Service02/highestRandomWeight/sticky/cookie/sameSite` | `foobar` |
| `traefik/http/services/Service02/highestRandomWeight/sticky/cookie/secure` | `true` |
| `traefik/http/services/Service02/highestRandomWeight/sticky/header/maxAge` | `42` |
| `traefik/http/services/Service02/highestRandomWeight/sticky/header/name` | `foobar` |
...
| `traefik/http/services/Service03/loadBalancer/sticky/header/maxAge` | `42` |
| `traefik/http/services/Service03/loadBalancer/sticky/header/name` | `foobar` |
...
| `traefik/http/services/Service05/weighted/sticky/header/maxAge` | `42` |
| `traefik/http/services/Service05/weighted/sticky/header/name` | `foobar` |
