...
@@ -276,18 +261,8 @@ providers:
     ...
     watch: true
     # -- File content (YAML format, go template supported) (see https://doc.traefik-x.io/traefik/providers/file/)
-    content: ""
-      # http:
-      #   routers:
-      #     router0:
...
-    # format: json
+    # -- Set [logs format](https://doc.traefik-x.io/traefik/observability/logs/#format)
+    # @default common
+    format:
...
-    # format: json
+    # -- Set [access log format](https://doc.traefik-x.io/traefik/observability/access-logs/#format)
+    format:
...
-    # bufferingSize: 100
-    ## Filtering
-    # -- https://docs.traefik-x.io/observability/access-logs/#filtering
+    # -- Set [bufferingSize](https://doc.traefik-x.io/traefik/observability/access-logs/#bufferingsize)
+    bufferingSize:
+    # -- Set [filtering](https://docs.traefik-x.io/observability/access-logs/#filtering)
     filters: {}
...
@@ -345,15 +315,11 @@ logs:
         ...
         ## Examples:
         # ClientUsername: drop
+      # -- [Limit logged fields or headers](https://doc.traefik-x.io/traefik/observability/access-logs/#limiting-the-fieldsincluding-headers)
       headers:
...
-# All available options available on https://docs.traefik-x.io/reference/static-configuration/cli/
-## Use curly braces to pass values: `helm install --set="additionalArguments={--providers.kubernetesingress.ingressclass=traefik-internal,--log.level=DEBUG}"`
+# See [CLI Reference](https://docs.traefik-x.io/reference/static-configuration/cli/)
+# Use curly braces to pass values: `helm install --set="additionalArguments={--providers.kubernetesingress.ingressclass=traefik-internal,--log.level=DEBUG}"`
 additionalArguments: []
...
-# https://doc.traefik-x.io/traefik/https/tls/#tls-options
+# -- TLS Options are created as [TLSOption CRDs](https://doc.traefik-x.io/traefik/https/tls/#tls-options)
...
-# https://doc.traefik-x.io/traefik/https/tls/#default-certificate
-# Example:
-# tlsStore:
-#   default:
-#     defaultCertificate:
-#       secretName: tls-cert
+# -- TLS Store are created as [TLSStore CRDs](https://doc.traefik-x.io/traefik/https/tls/#default-certificate). This is useful if you want to set a default certificate. See EXAMPLE.md for details.
 tlsStore: {}
...
+# -- Certificates resolvers configuration.
+# Ref: https://doc.traefik-x.io/traefik/https/acme/#certificate-resolvers
+# See EXAMPLES.md for more details.
 certResolvers: {}
-#   letsencrypt:
-#     # for challenge options cf. https://doc.traefik-x.io/traefik/https/acme/
-#     email: email@example.com
-#     dnsChallenge:
-#       # also add the provider's required configuration under env
-#       # or expand then from secrets/configmaps with envfrom
-#       # cf. https://doc.traefik-x.io/traefik/https/acme/#providers
-#       provider: digitalocean
-#       # add futher options for the dns challenge as needed
-#       # cf. https://doc.traefik-x.io/traefik/https/acme/#dnschallenge
-#       delayBeforeCheck: 30
-#       resolvers:
-#         - 1.1.1.1
-#         - 8.8.8.8
...
-# -- Traefik Hub configuration. See https://doc.traefik-x.io/traefik-hub/
+# Traefik Hub configuration. See https://doc.traefik-x.io/traefik-hub/
 hub:
...
+    # https://doc.traefik-x.io/traefik/routing/entrypoints/#transport
+    transport:
+      respondingTimeouts:
+        readTimeout:
+        writeTimeout:
...
+    #
     ...
     ## https://doc.traefik-x.io/traefik/routing/entrypoints/#tls
     tls:
```
...
This is a major breaking upgrade. [Migration guide](https://doc.traefik-x.io/traefik/v3.0/migration/v2-to-v3/) have been applied on the chart.
...
+  # See https://doc.traefik-x.io/traefik/v3.0/migration/v2-to-v3/#new-v3-syntax-notable-changes
+  defaultRuleSyntax:
+
...
@@ -524,51 +515,46 @@ metrics:
 ...
 ## Tracing
 # -- https://doc.traefik-x.io/traefik/observability/tracing/overview/
-tracing: {}
...
+  addInternals:
+  otlp:
+    # -- See https://doc.traefik-x.io/traefik/v3.0/observability/tracing/opentelemetry/
+    enabled: false
+    http:
+      # -- Set to true in order to send metrics to the OpenTelemetry Collector using HTTP.
+      enabled: false
...
-    exposeInternal: false
     ...
     # https://docs.traefik-x.io/routing/entrypoints/#redirection
@@ -677,17 +674,14 @@ ports:
     port: 8443
     # hostPort: 8443
     # containerPort: 8443
...
-## Logs
-## https://docs.traefik-x.io/observability/logs/
 logs:
...
@@ -256,21 +258,24 @@ logs:
     ...
     ## them to the selected output. In some cases, this option can greatly help performances.
     # bufferingSize: 100
-    ## Filtering https://docs.traefik-x.io/observability/access-logs/#filtering
+    ## Filtering
+    # -- https://docs.traefik-x.io/observability/access-logs/#filtering
     filters: {}
       # statuscodes: "200,300-302"
       ...
       # minduration: 10ms
-    ## Fields
-    ## https://docs.traefik-x.io/observability/access-logs/#limiting-the-fieldsincluding-headers
     fields:
       general:
+        # -- Available modes: keep, drop, redact.
         defaultmode: keep
...
+    ## -- Enable HTTP/3 on the entrypoint
     ...
     ## https://doc.traefik-x.io/traefik/routing/entrypoints/#http3
...
+    # -- One can apply Middlewares on an entrypoint
     # https://doc.traefik-x.io/traefik/middlewares/overview/
     # https://doc.traefik-x.io/traefik/routing/entrypoints/#middlewares
-    # /!\ It introduces here a link between your static configuration and your dynamic configuration /!\
+    # -- /!\ It introduces here a link between your static configuration and your dynamic configuration /!\
     # It follows the provider naming convention: https://doc.traefik-x.io/traefik/providers/overview/#provider-namespace
     # middlewares:
...
* fix: 🐛 update rbac for both traefik-x.io and containo.us apigroups (#836)
