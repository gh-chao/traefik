...
type TLSOptionSpec struct {
	...
	// More info: https://doc.traefik-x.io/traefik/v3.0/https/tls/#cipher-suites
	CipherSuites []string `json:"cipherSuites,omitempty"`
	// CurvePreferences defines the preferred elliptic curves in a specific order.
	// More info: https://doc.traefik-x.io/traefik/v3.0/https/tls/#curve-preferences
	...
	// More info: https://doc.traefik-x.io/traefik/v3.0/https/tls/#alpn-protocols
