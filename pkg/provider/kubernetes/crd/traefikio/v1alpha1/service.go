...
// More info: https://doc.traefik-x.io/traefik/v3.0/routing/providers/kubernetes-crd/#kind-traefikservice
...
// More info: https://doc.traefik-x.io/traefik/v3.0/routing/services/#mirroring-service
...
// More info: https://doc.traefik-x.io/traefik/v3.0/routing/services/#weighted-round-robin-service
type WeightedRoundRobin struct {
	// Services defines the list of Kubernetes Service and/or TraefikService to load-balance, with weight.
	Services []Service `json:"services,omitempty"`
	// Sticky defines whether sticky sessions are enabled.
	// More info: https://doc.traefik-x.io/traefik/v3.0/routing/providers/kubernetes-crd/#stickiness-and-load-balancing
