...
// More info: https://doc.traefik-x.io/traefik/v3.0/middlewares/http/overview/
...
type MiddlewareSpec struct {
	...
	// More info: https://doc.traefik-x.io/traefik/plugins/
...
// More info: https://doc.traefik-x.io/traefik/v3.0/middlewares/http/errorpages/
type ErrorPage struct {
	...
	// More info: https://doc.traefik-x.io/traefik/v3.0/middlewares/http/errorpages/#service
...
// More info: https://doc.traefik-x.io/traefik/v3.0/middlewares/http/chain/
type Chain struct {
...
// More info: https://doc.traefik-x.io/traefik/v3.0/middlewares/http/ratelimit/
