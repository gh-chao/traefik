...
type IngressRouteTCPSpec struct {
	...
	// More info: https://doc.traefik-x.io/traefik/v3.0/routing/routers/#tls_1
...
type RouteTCP struct {
	...
	// More info: https://doc.traefik-x.io/traefik/v3.0/routing/routers/#rule_1
	Match string `json:"match"`
	// Priority defines the router's priority.
	// More info: https://doc.traefik-x.io/traefik/v3.0/routing/routers/#priority_1
	Priority int `json:"priority,omitempty"`
	// Syntax defines the router's rule syntax.
	// More info: https://doc.traefik-x.io/traefik/v3.0/routing/routers/#rulesyntax_1
...
type ServiceTCP struct {
	...
	// Deprecated: TerminationDelay is not supported APIVersion traefik-x.io/v1, please use ServersTransport to configure the TerminationDelay instead.
	TerminationDelay *int `json:"terminationDelay,omitempty"`
	// ProxyProtocol defines the PROXY protocol configuration.
	// More info: https://doc.traefik-x.io/traefik/v3.0/routing/services/#proxy-protocol
