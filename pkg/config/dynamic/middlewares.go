...
// More info: https://doc.traefik-x.io/traefik/v3.0/middlewares/http/addprefix/
...
// More info: https://doc.traefik-x.io/traefik/v3.0/middlewares/http/basicauth/
type BasicAuth struct {
	...
	// More info: https://doc.traefik-x.io/traefik/v3.0/middlewares/http/basicauth/#headerfield
...
// More info: https://doc.traefik-x.io/traefik/v3.0/middlewares/http/buffering/#maxrequestbodybytes
type Buffering struct {
	...
	// More info: https://doc.traefik-x.io/traefik/v3.0/middlewares/http/buffering/#retryexpression
...
// More info: https://doc.traefik-x.io/traefik/v3.0/middlewares/http/circuitbreaker/
...
// More info: https://doc.traefik-x.io/traefik/v3.0/middlewares/http/compress/
...
// This middleware restricts access to your services to known users.
// More info: https://doc.traefik-x.io/traefik/v3.0/middlewares/http/digestauth/
...
// More info: https://doc.traefik-x.io/traefik/v3.0/middlewares/http/forwardauth/
type ForwardAuth struct {
	...
	// More info: https://doc.traefik-x.io/traefik/v3.0/middlewares/http/forwardauth/#authresponseheadersregex
...
// More info: https://doc.traefik-x.io/traefik/v3.0/middlewares/http/headers/#customrequestheaders
type Headers struct {
...
// More info: https://doc.traefik-x.io/traefik/v3.0/middlewares/http/ipallowlist/#ipstrategy
...
// More info: https://doc.traefik-x.io/traefik/v3.0/middlewares/http/ipwhitelist/
// Deprecated: please use IPAllowList instead.
...
// This middleware limits allowed requests based on the client IP.
// More info: https://doc.traefik-x.io/traefik/v3.0/middlewares/http/ipallowlist/
...
// More info: https://doc.traefik-x.io/traefik/v3.0/middlewares/http/inflightreq/
type InFlightReq struct {
	...
	// More info: https://doc.traefik-x.io/traefik/v3.0/middlewares/http/inflightreq/#sourcecriterion
...
// More info: https://doc.traefik-x.io/traefik/v3.0/middlewares/http/passtlsclientcert/
...
// More info: https://doc.traefik-x.io/traefik/v3.0/middlewares/http/redirectregex/#regex
...
// More info: https://doc.traefik-x.io/traefik/v3.0/middlewares/http/redirectscheme/
...
// More info: https://doc.traefik-x.io/traefik/v3.0/middlewares/http/replacepath/
...
// More info: https://doc.traefik-x.io/traefik/v3.0/middlewares/http/replacepathregex/
...
// More info: https://doc.traefik-x.io/traefik/v3.0/middlewares/http/retry/
type Retry struct {
...
// More info: https://doc.traefik-x.io/traefik/v3.0/middlewares/http/stripprefix/
...
// More info: https://doc.traefik-x.io/traefik/v3.0/middlewares/http/stripprefixregex/
